import { VALID_INPUTS } from '../api.js';
import { baseEngine, textToTune } from '../base/index.js';
...
export function webEngine(canvas) {
    ...
    const _gameloop = () => {
        ...
        ctx.drawImage(offscreenCanvas, (canvas.width - actualWidth) / 2, (canvas.height - actualHeight) / 2, actualWidth, actualHeight);
    ...
    const afterInput = (fn) => { afterInputs.push(fn); };
    const tunes = [];
    return {
        api: {
            ...api,
